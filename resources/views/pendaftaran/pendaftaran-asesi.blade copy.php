        ...
        <div class="navbar-custom">
            <div class="topbar container-fluid">
                ...
                <ul class="topbar-menu d-flex align-items-center gap-3">
                    ...
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="{{ asset('admin') }}/assets/images/flags/us.jpg" alt="user-image" class="me-sm-1 me-0" height="12">
                            <span class="d-none d-lg-inline-block align-middle">English</span>
                    ...
                    <li class="dropdown notification-list">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg py-0">
                            <div class="border-top-0 border-start-0 border-end-0 border border-dashed p-2">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h6 class="fs-16 fw-semibold m-0"> Messages</h6>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div style="max-height: 300px;" data-simplebar>
                                ...
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item read-noti card m-0 p-0 shadow-none">
                                    <div class="card-body">
                            ...
                            <!-- All-->
                            <a href="javascript:void(0);" class="dropdown-item text-primary text-decoration-underline fw-bold notify-item border-top border-light py-2 text-center">
                                View All
                            </a>
                    ...
                    <li class="dropdown notification-list">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg py-0">
                            <div class="border-top-0 border-start-0 border-end-0 border border-dashed p-2">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h6 class="fs-16 fw-semibold m-0"> Notification</h6>
                                    </div>
                                    <div class="col-auto">
                                        <a href="javascript: void(0);" class="text-dark text-decoration-underline">
                                            <small>Clear All</small>
                    ...
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle arrow-none nav-user" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            ...
                            <span class="d-lg-block d-none">
                                <h5 class="fw-normal my-0">Adams<i class="ri-arrow-down-s-line fs-22 d-none d-sm-inline-block align-middle"></i></h5>
                            </span>
                        </a>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="text-center">
                                                            ...
                                                            <p class="w-75 mx-auto mb-2">Quisque nec turpis at urna dictum luctus. Suspendisse convallis dignissim eros at volutpat. In egestas mattis
