                            ...
                            <form>
                                <div id="progressbarwizard">
                                    ...
                                    <ul class="nav nav-pills nav-justified form-wizard-header mb-3">
                                        <li class="nav-item">
                                            <a href="#data-pribadi" data-bs-toggle="tab" data-toggle="tab" class="nav-link rounded-0 py-2">
                                                <i class="ri-account-circle-line fw-normal fs-20 me-1 align-middle"></i>
                                                <span class="d-none d-sm-inline">Data Pribadi</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#data-pekerjaan" data-bs-toggle="tab" data-toggle="tab" class="nav-link rounded-0 py-2">
                                                <i class="ri-profile-line fw-normal fs-20 me-1 align-middle"></i>
                                                <span class="d-none d-sm-inline">Data Pekerjaan</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="tab-content b-0 mb-0">
                                        ...
                                        <div class="tab-pane" id="data-pribadi">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="row mb-3">
                                                        <label class="col-md-3 col-form-label" for="nama_lengkap">Nama Lengkap</label>
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" required>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                        <label class="col-md-3 col-form-label" for="nik"> No. KTP / NIK</label>
                                                        <div class="col-md-9">
                                                            <input type="text" id="nik" name="nik" class="form-control" required>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                        <label class="col-md-3 col-form-label" for="tempat_lahir">Tempat / TanggalLahir</label>
                                                        <div class="col-md-4">
                                                            <input type="text" id="tempat_lahir" name="tempat_lahir" class="form-control" required>
                                                        </div>
                                                         <div class="col-md-4">
                                                           <input type="text" id="basic-datepicker" name="tanggal_lahir" class="form-control" required>
                                                        </div>
                                                    </div>
                                                </div> <!-- end col -->
                                            </div> <!-- end row -->
                                        ...
                                        <div class="tab-pane" id="data-pekerjaan">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="row mb-3">
