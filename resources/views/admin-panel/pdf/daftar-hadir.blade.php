                ...
                @foreach ($item->asesis as $asesi)
                    @if ($loop->iteration <= $maxRow)
                        <tr>
                            ...
                            <td>{{ ucwords(strtolower($asesi->nama_lengkap)) }}</td>
        ...
        <table width="100%" style="margin-top:20px;">
            <tr>
                ...
                <td width="60%" style="vertical-align:top;">
                    Mengetahui,<br>
                    <span class="value">Direktur {{ $item->kegiatanJadwal->lsp->lsp_nama }}</span>
                    <br><br><br><br><br><br>
                    <u class="value" style="font-weight: bold;">{{ $item->kegiatanJadwal->lsp->lsp_direktur }}</u>
                </td>
