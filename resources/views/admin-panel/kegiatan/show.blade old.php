            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="nav nav-pills nav-justified gap-0 p-3 text-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <li class="nav-item mt-2"><a class="nav-link fs-5 active border-primary border p-2" data-bs-toggle="tab" data-bs-target="#daftar_lsp" type="button" role="tab" aria-controls="home" aria-selected="true" href="#daftar_lsp"></i> Daftar LSP</a></li>
                        <li class="nav-item mt-2"><a class="nav-link fs-5 border-primary border p-2" data-bs-toggle="tab" data-bs-target="#daftar_asesi" type="button" role="tab" aria-controls="home" aria-selected="true" href="#daftar_asesi"></i> Daftar Calon Asesi</a></li>
                    </div>
